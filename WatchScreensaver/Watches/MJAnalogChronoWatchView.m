...
- (void)onTimeChanged:(double)hour minute:(double)minute second:(double)second {
    ...
    self.secondMiniHandImageView.layer.position = CGPointMake(CGRectGetMidX(self.secondMiniHandImageView.frame), CGRectGetMidY(self.secondMiniHandImageView.frame));
    self.secondMiniHandImageView.layer.anchorPoint = CGPointMake(0.5f, 0.5f);
